...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
            ...
            if (isFormValid) {
                ...
                .then(response => {
                    if (response.ok) {
                        ...
                        contactForm.reset();
                        fields.forEach(field => field.classList.remove('form-input-success'));
                    } else {
                ...
                .catch(error => {
                    ...
                    if (!contactForm.querySelector('.form-error-message')) {
                        ...
                        errorMessage.textContent = contactForm.getAttribute('data-error-message') || 'Something went wrong. Please try again.';
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (field.classList.contains('form-input-error') || field.classList.contains('form-input-success')) {
                validateField(field);
            }
        });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8edd39bf-62ef-4535-843b-6be607f1720a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8edd39bf-62ef-4535-843b-6be607f1720a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8edd39bf-62ef-4535-843b-6be607f1720a';
